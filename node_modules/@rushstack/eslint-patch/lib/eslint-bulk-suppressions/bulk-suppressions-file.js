...
exports.serializeSuppression = exports.writeSuppressionsJsonToFile = exports.getSuppressionsConfigForEslintrcFolderPath = exports.suppressionsJsonByFolderPath = void 0;
...
exports.suppressionsJsonByFolderPath = new Map();
function getSuppressionsConfigForEslintrcFolderPath(eslintrcFolderPath) {
    const cachedSuppressionsConfig = exports.suppressionsJsonByFolderPath.get(eslintrcFolderPath);
    let shouldLoad;
    ...
    if (shouldLoad) {
        ...
        exports.suppressionsJsonByFolderPath.set(eslintrcFolderPath, { readTime: Date.now(), suppressionsConfig });
    }
...
function writeSuppressionsJsonToFile(eslintrcDirectory, suppressionsConfig) {
    exports.suppressionsJsonByFolderPath.set(eslintrcDirectory, { readTime: Date.now(), suppressionsConfig });
